...
source("calc_time_series_intpp.R")

models = c("CESM","CM4","CMCC", "EC-Earth", "GFDL", "IPSL", "MPI", "UKESM")
lapply(models, time_series_intpp)
...
time_series_intpp(model.name = "CESM")
...
time_series_intpp(model.name = "CM4")
...
time_series_intpp(model.name = "CMCC")
...
time_series_intpp(model.name = "EC-Earth")
...
time_series_intpp(model.name = "GFDL")
...
time_series_intpp(model.name = "IPSL")
...
time_series_intpp(model.name = "MPI")

#UKESM ------------

time_series_intpp(model.name = "UKESM")
...
7. supplemental EZ depth 10% NPP max definition comparison
```{r}
setwd("~/senior_thesis/")
source("libraries.R")
source("get_time.R")
setwd("~/time_series_analysis/code/")
source("calc_time_series_ez_depth_10percent.R")
source("calc_time_series_expc_ez.R")
source("calc_time_series_expc_UKESM.R")
...
time_series_ez_depth_10(model.name = "CESM",
                     lon.length = 1:320,
                     lat.length = 1:384,
                     UKESM.file = NA)
...
#this one is done at 10% max NPP
time_series_ez_depth_10(model.name = "CM4",
                     lon.length = 1:360,
                     lat.length = 1:180,
                     UKESM.file = NA)
...
time_series_ez_depth_10(model.name = "CMCC",
                     lon.length = 1:362,
                     lat.length = 1:292,
                     UKESM.file = NA)
...
time_series_ez_depth_10(model.name = "EC-Earth",
                     lon.length = 1:362,
                     lat.length = 1:292,
                     UKESM.file = NA)
...
time_series_ez_depth_10(model.name = "GFDL",
                     lon.length = 1:360,
                     lat.length = 1:180,
                     UKESM.file = NA)
...
time_series_ez_depth_10(model.name = "IPSL",
                     lon.length = 1:362,
                     lat.length = 1:332,
                     UKESM.file = NA)
...
time_series_ez_depth_10(model.name = "MPI",
                     lon.length = 1:802,
                     lat.length = 1:404,
                     UKESM.file = NA)
...
#2015-2100
time_series_ez_depth_10(model.name = "UKESM",
                     lon.length = 1:360,
                     lat.length = 1:330,
                     UKESM.file = 5)
...
#calculate POC flux at ez depth time series
time_series_expc_UKESM(DH = "ez_depth_10", file = 1)
time_series_expc_UKESM(DH = "ez_depth_10", file = 2)
time_series_expc_UKESM(DH = "ez_depth_10", file = 3)
time_series_expc_UKESM(DH = "ez_depth_10", file = 4)
time_series_expc_UKESM(DH = "ez_depth_10", file = 5)
time_series_expc_UKESM(DH = "ez_depth_10", file = 6)

setwd("~/time_series_analysis/files/POC_EZ/UKESM_uncombined/")
df.sep <- list.files(pattern = "ez_10.csv")
...
write_csv(combined, "~/time_series_analysis/files/POC_EZ/UKESM_time_series_expc_ez_10.csv")

# combine models ---------

setwd("~/time_series_analysis/files/POC_EZ/")
df.sep <- list.files(pattern = "*_time_series_expc_ez_10.csv$")
...
write_csv(df, file = "~/time_series_analysis/files/all_models/time_series_expc_ez_10_all.csv")

#calculate average for each model from 1850-1900
mean1850_1900 <- dplyr::filter(df, between(Year, 1850, 1900)) %>% 
...
meanEC_Earth <- dplyr::filter(df,between(Year,2015,2035)) %>%
  summarise_if(is.numeric, mean, na.rm = TRUE)
...
#save df
write_csv(normalized.ez, "~/time_series_analysis/files/all_models/normalized_time_series_expc_ez_10.csv")
