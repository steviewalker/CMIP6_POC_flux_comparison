...
rg_time_series_MLDmax("CESM")
rg_time_series_MLDmax("CM4")
rg_time_series_MLDmax("CMCC")
rg_time_series_MLDmax("EC-Earth")
rg_time_series_MLDmax("GFDL")
rg_time_series_MLDmax("IPSL")
rg_time_series_MLDmax("MPI")
rg_time_series_MLDmax("UKESM")



rg_time_series_ez_depth(model.name = "CESM", UKESM.file = NA)
rg_time_series_ez_depth(model.name = "CM4", UKESM.file = NA)
rg_time_series_ez_depth(model.name = "CMCC", UKESM.file = NA)
rg_time_series_ez_depth(model.name = "EC-Earth", UKESM.file = NA)
rg_time_series_ez_depth(model.name = "GFDL", UKESM.file = NA)
rg_time_series_ez_depth(model.name = "IPSL", UKESM.file = NA)
rg_time_series_ez_depth(model.name = "MPI", UKESM.file = NA)
...
The area sums come from GFDL regridded data, calc_region_area.R
```{r}
setwd("~/regional_time_series_analysis/code")
...
source('libraries.R')
setwd("~/regional_time_series_analysis/code/")
source('calc_regional_time_series_intpp.R')
...
models = c("CESM","CM4","EC-Earth","UKESM") 
models =  c("GFDL","IPSL", "MPI", "CMCC")

# 4 regions used in manuscript
